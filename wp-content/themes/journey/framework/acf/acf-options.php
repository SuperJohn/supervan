	...
	register_field_group(array (
		...
		'fields' => array (
			array (
				...
				'label' => __( 'Option featured image', 'ilgelo' ),
				'name' => 'featured_image_post',
				'type' => 'true_false',
				'message' =>  __( 'Show the Featured Image on the Single Post', 'ilgelo' ),				'default_value' => 1,
			),
			array (
			...
			array (
				...
				'name' => 'gallery_post',
				'type' => 'gallery',
				'instructions' => __( 'Upload your image should be minimum width 800px for best results.', 'ilgelo' ),
			...
			array (
				...
				'label' => __( 'Add Parallax Cover Image?', 'ilgelo' ),				               'name' => 'header_parallax_post',
				'type' => 'true_false',
		...
		'location' => array (
			...
			array (
				array (
					'param' => 'page_template',
					'operator' => '==',
					'value' => 'indie-template-infinite-post.php',
					'order_no' => 0,
					'group_no' => 6,
				),
			),
