...
function indie_enqueue_scripts() {
	...
	wp_enqueue_script('wow', get_template_directory_uri().'/include/js/wow.min.js', array(),'',false);
	wp_enqueue_script('plugin', get_template_directory_uri().'/include/js/plugin.js', array(),'',true);
	wp_enqueue_script('isotope', get_template_directory_uri().'/include/js/jquery.isotope.js', array(),'',true);
	wp_enqueue_script('modernizr', get_template_directory_uri().'/include/js/modernizr.js', array(),'',true);
	wp_enqueue_script('bootstrap', get_template_directory_uri().'/include/js/bootstrap.min.js', array(),'',true);
	wp_enqueue_script('carousel', get_template_directory_uri().'/include/js/owl.carousel.min.js', array(),'',true);
	wp_enqueue_script('main', get_template_directory_uri().'/include/js/main.js', array(),'',true);
	wp_enqueue_script('parallax', get_template_directory_uri().'/include/js/parallax.min.js', array(),'',true);
	wp_enqueue_script('vide', get_template_directory_uri().'/include/js/jquery.vide.js', array(),'',true);
