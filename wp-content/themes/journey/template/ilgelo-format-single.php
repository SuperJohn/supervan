<?php
	...
	function ilgelo_format_single_headerparallax() {
		...
		if (class_exists('acf') && get_field('header_parallax_post')) {
			echo "<div class='parallax-postimg' data-natural-width='1600' data-natural-height='800' data-parallax='scroll' data-bleed='0' position='center' speed='0.2' data-image-src='" . get_field("post_header_image") . "'>";
